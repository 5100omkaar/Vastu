    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Sign in to your VastuVista account</p>
        </div>
            ...
            {otpSent && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-border bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 text-center tracking-widest"
                  required
                  maxLength={6}
                />
              </div>
        ...
        <button
          onClick={() => signInWithGoogle().catch((e: any) => toast({ title: "Google sign in failed", description: e.message, variant: "destructive" }))}
